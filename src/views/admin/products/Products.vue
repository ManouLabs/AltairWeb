    ...
    <div>
        ...
        <template v-else>
            <DataTable
                ...
                :currentPageReportTemplate="t('common.pagination.showing_to_of_entity', { first: '{first}', last: '{last}', totalRecords: '{totalRecords}', entity: t('entity.products') })"
                resizableColumns
            ...
            >
                ...
                <Column columnKey="number" field="number" sortable class="min-w-28">
                    ...
                    <template #body="{ data }">
                        <DataCell><span class="font-mono text-primary font-semibold cursor-pointer hover:underline" @click="viewRecord(data)">{{ data.number }}</span></DataCell>
                    </template>
                </Column>
