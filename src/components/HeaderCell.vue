...
const props = defineProps({
    ...
    reorderTooltip: { type: String, default: '' },
    lockTooltip: { type: String, default: '' },
    unlockTooltip: { type: String, default: '' }
});
...
<template>
    <div class="flex justify-between w-full items-center pl-4">
